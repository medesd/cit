...
const COM01 = (props) => {
    ...
    useEffect(() => {
        ...
        props.actions.setHeaderTitle("Devis");
        return () => {
                ...
                >
                    ...
                    >
                        <Select showSearch onChange={(x, e) => {
                            if (x !== null) {
                                axios.create().get('/api/com01/generate').then(ft => {
                                    form.setFieldsValue({com01Ref: ft.data});
                                })
                ...
                <div style={{minWidth: 960, width: 960, minHeight: 1000}}
                    ...
                    <div style={{minWidth: 960, minHeight: 1300}} className="m-0 container">
                        <div className="row border justify-content-between flex-nowrap align-items-center">
                            ...
                            <div className="col-xs">
                                <h2 className="font-weight-bold">Devis</h2>
                            </div>
                        ...
                        {parseInt(key) + 1 === presentArrayForm.length ? <div className="row justify-content-center">
                            <div className="col-xs">
                                <div className="text-center">
                                    <p className={"m-0"}>ARRÊTER LE MONTANT DE LA PRESENT DEVIS A LA SOMME DE :</p>
                                    <p style={{fontSize: 18}}
    ...
    const dataDevis = <div className="d-flex flex-column align-items-center">
            ...
            <div style={{minWidth: 960, minHeight: 1300}} className="m-0 container">
                ...
                <div className="row mt-3 mb-0 justify-content-center">
                    <div className="col-xs"><h2 className="m-0">
                        Devis N° {state.form?.com01Ref}
                    </h2></div>
                </div>
                <div className="row justify-content-center">
                    <div className="col-xs mb-2"><span>
                Nous vous prions de bien vouloir trouver, ci-après notre Devis pour l’étude et suivi relatif aux :
            </span></div>
                </div>
                <div className="row">
                    <div className="col">
            ...
            for (let print = 0; print < classes.length; print++) {
                html2canvas(document.getElementsByClassName("forPrintPages").item(print), {scale: 3}).then(canvas => {
                    ...
                    if (print === classes.length - 1) {
                        ...
                        axios.create().post('/api/com01', value).then(null)
...
export default connect(null, dtp)(COM01);
