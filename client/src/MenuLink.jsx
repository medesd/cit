...
const MenuLink = (props) => {
    ...
    const roles = ParseJwt().roles.map(x => x.authority).includes('ROLE_ADMIN');
        ...
        <ReactDirective>
            ...
            >
                <SubMenu key="sub1" icon={<BookOutlined/>} title="Etude">
                    ...
                    <Menu.Item data-react-if={roles} onClick={() => history.push("/archive")} key="34">Les projets archivée</Menu.Item>
                    <Menu.Item onClick={() => history.push("/planning-general")} key="1">Planning général</Menu.Item>
                    <Menu.Item onClick={() => history.push("/new-ordre-service/Etude")} key="2">Ordre
                        service</Menu.Item>
                    <Menu.Item data-react-if={roles} onClick={() => history.push("/etu-04")} key="3">Demande supplémentaire</Menu.Item>
                    ...
                    <Menu.Item onClick={() => history.push("/taches-details")} key="32">Récapitulatif de la
                        semaine</Menu.Item>
                    <Menu.Item data-react-if={roles} onClick={() => history.push("/project-res")} key="33">Récapitulatif</Menu.Item>
                </SubMenu>
                ...
                <SubMenu key="sub2" icon={<BuildOutlined/>} title="Suivi">
                    ...
                    <Menu.Item onClick={() => history.push("/new-ordre-service/Suivi")} key="8">Ordre
                        service</Menu.Item>
                    <Menu.Item  onClick={() => history.push("/sui-05")} key="9">Planning général</Menu.Item>
                </SubMenu>

                <SubMenu data-react-if={roles} key="sub3" icon={<ShopOutlined/>} title="Achat">
                    ...
                    <Menu.Item onClick={() => history.push("/ach-03")} key="12">Etat de suivi des
                        prestataires</Menu.Item>
                    <Menu.Item onClick={() => history.push("/ach-04")} key="13">Liste des prestataires & prestataires
                        évolues</Menu.Item>
                    <Menu.Item onClick={() => history.push("/ach-05")} key="14">Tableau comparatif des
                        prestataires</Menu.Item>
                </SubMenu>
                <SubMenu data-react-if={roles} key="sub4" icon={<SnippetsOutlined/>}
                         title="Facturation">
                ...
                <SubMenu key="sub5" icon={<TeamOutlined/>} title="Ressources Humains">
                    <Menu.Item data-react-if={roles} onClick={() => history.push("/ajoute-emp")} key="17">Personnel</Menu.Item>
                    <Menu.Item onClick={() => history.push("/rh-02")} key="31">Fiche d'évaluation des
                        formations</Menu.Item>
                    <Menu.Item onClick={() => history.push("/rh-03")} key="18">Feuille de présence</Menu.Item>
                    <Menu.Item data-react-if={roles} onClick={() => history.push("/rh-05")}
                               key="19">Planning des congés</Menu.Item>
                    <Menu.Item data-react-if={roles} onClick={() => history.push("/rh-06")}
                               key="20">Planning et suivi des
                        formations</Menu.Item>
                ...
                <SubMenu data-react-if={roles} key="sub6" icon={<LaptopOutlined/>}
                         title="Infrastructure">
                    <Menu.Item onClick={() => history.push("/inf-02")} key="23">Liste du matériel</Menu.Item>
                </SubMenu>
                <SubMenu data-react-if={roles} key="sub7" icon={<IdcardOutlined/>}
                         title="Commercial">
                ...
                <SubMenu key="sub8" icon={<WalletOutlined/>} title="GMQ">
                    ...
                    <Menu.Item data-react-if={roles} onClick={() => history.push("/gmq-02")}
                               key="27">Bordereau de diffusion</Menu.Item>
                    <Menu.Item key="28">Fiche indicateur</Menu.Item>
                    <Menu.Item onClick={() => history.push("/gmq-07")} key="29">Etat des actions
                        d'amélioration</Menu.Item>
