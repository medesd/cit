        ...
        <ReactDirective>
            ...
            >
                <SubMenu key="sub1" icon={<BookOutlined/>} title="Etude">
                    ...
                    <Menu.Item onClick={() => history.push("/archive")} key="34">Les projets archivée</Menu.Item>
                ...
                <SubMenu data-react-if={roles.includes("ROLE_ADMIN")} key="sub3" icon={<ShopOutlined/>} title="Achat">
                ...
                <SubMenu data-react-if={roles.includes("ROLE_ADMIN")} key="sub4" icon={<SnippetsOutlined/>}
                         title="Facturation">
                ...
                <SubMenu key="sub5" icon={<TeamOutlined/>} title="Ressources Humains">
                    ...
                    <Menu.Item data-react-if={roles.includes("ROLE_ADMIN")} onClick={() => history.push("/rh-05")}
                               key="19">Planning des congés</Menu.Item>
                    <Menu.Item data-react-if={roles.includes("ROLE_ADMIN")} onClick={() => history.push("/rh-06")}
                ...
                <SubMenu data-react-if={roles.includes("ROLE_ADMIN")} key="sub6" icon={<LaptopOutlined/>}
                         title="Infrastructure">
                    <Menu.Item onClick={() => history.push("/inf-02")} key="23">Liste du matériel</Menu.Item>
                </SubMenu>
                <SubMenu data-react-if={roles.includes("ROLE_ADMIN")} key="sub7" icon={<IdcardOutlined/>}
                         title="Commercial">
                ...
                <SubMenu key="sub8" icon={<WalletOutlined/>} title="GMQ">
                    ...
                    <Menu.Item data-react-if={roles.includes("ROLE_ADMIN")} onClick={() => history.push("/gmq-02")}
